                ...
                <div class="col-sm-9">
                	<div class="col-sm-12">
                		<ul class="nav nav-tabs">
                			<li class="nav active"><a href="#classpage.php" data-toggle="tab">Classes</a></li>
                			<li class="nav"><a href="#profilepage.php" data-toggle="tab">Profile</a></li>
                			<li class="nav"><a href="#forum.php" data-toggle="tab">Forum</a></li>
                		</ul>
