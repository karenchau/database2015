...
<html lang="en">
  ...
  $query = "SELECT id_eval_group, name, type, size, uploadtime from report where group_id in (SELECT id_report_group FROM evaluation WHERE class = '$class' AND id_eval_group = '$group_entry')";
  $result = mysqli_query($db,$query);
